...
public class ToDoListMain {
    ...
    //add in a class level DataSource variable
    ...
    private static void displayList() throws SQLException {
        ...
        try ( Connection conn = ds.getConnection()) {
            Statement stmt = conn.createStatement();   //using a Statement and not a PreparedStatement.
    ...
    private static void updateItem() throws SQLException {
        ...
        try (Connection conn = ds.getConnection()) {
            ...
            rs.next();
            ToDo td = new ToDo();  //we use ResultSet to build a ToDo object
